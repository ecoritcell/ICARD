...
<html lang="en">
    <head>
        ...
        <title>ICARD:Print Non Gaz Applications</title>
  <!-- Bootstrap Core CSS -->
...
%>
       ...
       <%
int i=1;
String query="select ID_NO,EMPNO,EMPNAME,DESIGNATION,DOB,DEPARTMENT,STATION,RES_ADDRESS,RLY_NUMBER,MOBILE_NUMBER,EMERGENCY_CONTACT_NAME,EMERGENCY_CONTACT_NO,PHOTO,SIGNATURE,LAST_UPDATE,DEPT_SLNO,dept_name,qr_code from non_gaz_master ngm,department d where d.dept_code=ngm.department and status='3' order by id_no";
