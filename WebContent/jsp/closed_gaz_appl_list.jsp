...
<%
int i=1;
String query="select ID_NO,RUID_NO,EMPNAME,DESIGNATION,DOB,DEPARTMENT,STATION,RES_ADDRESS,RLY_NUMBER,MOBILE_NUMBER,EMERGENCY_CONTACT_NAME,EMERGENCY_CONTACT_NO,PHOTO,SIGNATURE,LAST_UPDATE,dept_name from gaz_master gm,department d where d.dept_code=gm.department and status='C' order by last_update";
