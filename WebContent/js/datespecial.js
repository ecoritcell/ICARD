...
var SpanBgColor = "#036DA4"; //span background color
var MonthYearColor = "#BA4C32"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#2A83C1"; //var WeekHeadColor="#18861B";//Background Color in Week header.
...
var TodayColor = "#D0FF00"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#F67B16"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#BA4C32"; //color of font of Year selector.
var MthSelColor = "#BA4C32"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#7BE4FC"; //color when mouse move over.
var DisableColor = "#999966"; //color of disabled cell.
var CalBgColor = "#E5F1FF"; //Background color of Calendar window.
...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='../images/close.png' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
	...
	if (!winCal)
	{
		...
		span.style.top = (ypos - CalPosOffsetY) + 60+'px';
	...
	else
	{
		...
		if (bNewCal === true)
		{
			...
			winCal.style.top = (ypos - CalPosOffsetY) + 60+'px';
		}
	}
