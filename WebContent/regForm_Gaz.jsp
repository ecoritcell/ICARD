...
<html lang="en">
    <head>
        ...
        <title>ICARD:Reg Form(Gaz)</title>
  <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper" >
            ...
            <div id="page-wrapper"><br>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="page-header">Employee Registration Form (Gazetted)</h2>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                   <h4>Employee Registration Form (Gazetted)</h4>
                                    <h3><%=request.getParameter("ack")==null?"":request.getParameter("ack") %></h3>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                       
          <form name="GazFormSubmit" id="GazFormSubmit" method="post" ENCTYPE="multipart/form-data" target="_self"  action="./GazFormSubmit"  >	
		...
		<TABLE  class="table" >
	          ...
	          <TR class="success">
				...
				<div class="form-group has-success">
                   <label>Employee Name:<code><i class="fa fa-asterisk"></i></code></label>
                     <input name="EMP_NAME" id="emp_name" type="text"  class="form-control" placeholder="Enter Employee Name" required />                                              
                </div>
				</TD>
				...
				<TD>			
				<div class="form-group has-success">
                   <label>RUID No:<code><i class="fa fa-asterisk"></i></code></label>
                     <input name="RUID_NO" type="text"  class="form-control" placeholder="Enter RUID No." required />                                              
                </div>
				</TD>			 			 
	       </TR>
	       <TR class="success">
	       ...
	       <TR class="info">
				<TD>
				<div class="form-group has-success">
                  <label>Upload Hindi Name:<code><i class="fa fa-asterisk"></i></code></label>
                     <input name="HINDI_NAME" type="file"  class="form-control" id="file3" accept="image/gif, image/jpeg, image/png" onchange="loadHindiName(event)" required />                                                
                </div>					
				</TD>
				<TD>
						<img id="hindi_name" width="160px"  />			
				</TD>
				<TD>
	       ...
	       <TR class="info">
				<TD>
				<div class="form-group has-success">
                  <label>Upload Hindi Designation:<code><i class="fa fa-asterisk"></i></code></label>
                     <input name="HINDI_DESIG" type="file"  class="form-control" id="file4" accept="image/gif, image/jpeg, image/png" onchange="loadHindiDesig(event)" required />                                                
                </div>					
				</TD>
				<TD>
						<img id="hindi_desig" width="160px"  />			
				</TD>
				<TD>
...
var loadHindiName = function(event) {
	var image = document.getElementById('hindi_name');
	image.src = URL.createObjectURL(event.target.files[0]);
};
var loadHindiDesig = function(event) {
	var image = document.getElementById('hindi_desig');
	image.src = URL.createObjectURL(event.target.files[0]);
};
</script>
<script>
